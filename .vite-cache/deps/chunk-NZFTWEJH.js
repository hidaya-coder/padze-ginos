import {
  require_jsx_runtime
} from "./chunk-NFZGTFWP.js";
import {
  require_react_dom
} from "./chunk-WZ5YIGX4.js";
import {
  require_react
} from "./chunk-I4IV43OG.js";
import {
  BaseRootRoute,
  BaseRoute,
  BaseRouteApi,
...
function useLinkProps(options, forwardedRef) {
  ...
  if (_isServer) {
    ...
    const isActive2 = (() => {
      ...
      const includeSearch = (activeOptions == null ? void 0 : activeOptions.includeSearch) ?? true;
      if (includeSearch) {
  ...
  const matchState = useRouterState({
    select: (s) => {
      ...
      return {
        ...
        resetKey: s.loadedAt,
        parentRouteId: (_a2 = s.matches[matchIndex - 1]) == null ? void 0 : _a2.routeId
      };
    },
    structuralSharing: true
  });
...
function HeadContent() {
  ...
  const filteredTags = hydrated ? tags.filter((tag) => {
    var _a2;
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NZFTWEJH.js.map
